...
public class MyAccountsTest extends BaseTest {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        myAccounts.enterFirstName("Priya");
        myAccounts.enterLastName("Tester");
        myAccounts.enterEmail("Priya34568910@gmail.com");
        myAccounts.enterPhoneNumber("123456789");
        myAccounts.enterPassword("Priya@123");
        myAccounts.enterConfirmPassword("Priya@123");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        myAccounts.enterEmailId("Priya1234568@gmail.com");
